...
Windows 10/11 x64 用户使用 0.2.0 发布文件：

- **AI-ToDo-0.2.0-x64-nsis.exe**：安装版，可选择安装目录，创建桌面和开始菜单快捷方式，支持系统卸载。
- **AI-ToDo-0.2.0-x64-portable.exe**：便携版，双击即可运行，不需要安装。
...
- 所有新配置均在软件内完成，安装版不读取源码目录的 `.env`，也不依赖网关服务。旧版使用者需在设置中选择启用并重新填入密钥。
