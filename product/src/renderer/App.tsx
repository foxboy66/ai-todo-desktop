...
import { buildSchedule, defaultAvailability, formatScheduleLabel, formatTime, getCheckpoints, getReminderInterval, getScheduleSegments, parseTime, starterTasks, type AvailabilityBlock, type Priority, type ScheduledTask, type Task } from '@/shared/domain';
...
function ScheduleTime({ task, onUpdateTime }: { task: ScheduledTask; onUpdateTime: (id: string, field: 'start' | 'end', value: string) => void }) {
